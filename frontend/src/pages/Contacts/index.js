...
const Contacts = () => {
  ...
  return (
    <MainContainer className={classes.mainContainer}>
      ...
      <ConfirmationModal
        title={
          confirmAction === "deleteAll"
            ? i18n.t("Excluir Todos os Contatos")
            : deletingContact
      ...
      >
        {confirmAction === "deleteAll"
          ? i18n.t("Tem certeza que deseja deletar todos os contatos? Esta ação é irreversível e todos os contatos serão excluídos permanentemente.")
          : deletingContact
