...
const TicketListItem = ({ ticket, userId, isGroup }) => {
    ...
    <React.Fragment key={ticket.id}>
      ...
      >
        ...
        <ListItemText
          ...
          secondary={
            <span>
              ...
              {ticket.queueId && (
                <Tooltip title={i18n.t("Departamento")}>
                  <Badge
                    className={classes.Radiusdot}
                    // overlap="rectangular"
                    style={{
              ...
              {uName && (
                <Tooltip title={i18n.t("Responsável")}>
                  <Badge
                    className={classes.Radiusdot}
                    // overlap="rectangular"
                    style={{
        ...
        {(ticket.status === "pending" && (ticket.queue === null || ticket.queue === undefined)) && (
          <Tooltip title={i18n.t("Iniciar atendimento")}>
        ...
        {ticket.status === "open" && !ticket.isGroup && user?.name !== uName && (
          <Tooltip title={i18n.t("Iniciar atendimento")}>
