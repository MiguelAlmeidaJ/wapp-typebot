      ...
      >
        <List style={{ paddingTop: 0 }}>
          {ticketsList.length === 0 && !loading ? (
            ...
            <>
              {ticketsList
                .filter(ticket => ticket.isGroup.toString() === "false") // Filtro para excluir tickets de grupo
                .filter(ticket => selectedAgentId === 0 || ticket.userId === selectedAgentId) // Filtro para o atendente selecionado
                .map(ticket => (
