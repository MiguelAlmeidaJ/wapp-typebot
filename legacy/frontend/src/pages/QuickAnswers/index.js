            ...
            <>
              {quickAnswers.map((quickAnswer) => (
                <TableRow key={quickAnswer.id}>
                  <TableCell align="left">{quickAnswer.shortcut}</TableCell>
                  <TableCell align="left" title={quickAnswer.message}>
                    {quickAnswer.message.length > 120
                      ? `${quickAnswer.message.substring(0, 120)}...`
                      : quickAnswer.message}
                  </TableCell>
                  <TableCell align="center">
                    <IconButton
