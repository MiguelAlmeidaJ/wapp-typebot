...
const ListCompaniesService = ({ searchParam = "", pageNumber = "1", }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { count, rows: companies } = yield Company_1.default.findAndCountAll({
