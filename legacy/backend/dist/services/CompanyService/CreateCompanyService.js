...
const CreateCompanyService = (companyData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const companySchema = Yup.object().shape({
        name: Yup.string()
            ...
            .test("Check-unique-name", "ERR_COMPANY_NAME_ALREADY_EXISTS", (value) => __awaiter(void 0, void 0, void 0, function* () {
            if (value) {
                const companyWithSameName = yield Company_1.default.findOne({
                    where: { name: value }
                });
    ...
    try {
        yield companySchema.validate({ name });
    }
    catch (err) {
    ...
    if (!created) {
        yield user.update({ companyId: company.id });
    }
    yield Setting_1.default.findOrCreate({
        where: {
            companyId: company.id,
            key: "asaas"
        },
