...
const DeleteTicketService_1 = __importDefault(require("../services/TicketServices/DeleteTicketService")); // Importando o serviço de fechamento do ticket
...
console.log(ticket._previousDataValues)
