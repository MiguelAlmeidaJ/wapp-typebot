...
const show = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { companyId } = req.user;
    const schedule = yield (0, ShowService_1.default)(scheduleId, companyId);
    return res.status(200).json(schedule);
});
exports.show = show;
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { companyId } = req.user;
    const schedule = yield (0, UpdateService_1.default)({ scheduleData, id: scheduleId, companyId });
    const io = (0, socket_1.getIO)();
    io.emit("schedule", {
        action: "update",
        schedule
...
const remove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { scheduleId } = req.params;
    const { companyId } = req.user;
    yield (0, DeleteService_1.default)(scheduleId, companyId);
    const io = (0, socket_1.getIO)();
    io.emit("schedule", {
        action: "delete",
        scheduleId
