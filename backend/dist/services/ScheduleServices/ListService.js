...
const ListService = ({ searchParam, contactId = "", userId = "", pageNumber = "1", companyId }) => __awaiter(void 0, void 0, void 0, function* () {
    let whereCondition = {};
    const limit = 20;
    ...
    whereCondition = Object.assign(Object.assign({}, whereCondition), { companyId: {
